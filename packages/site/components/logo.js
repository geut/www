...
export default React.forwardRef((props, ref) => {
  return (
    <svg {...props} ref={ref} type="image/svg+xml" x="0px" y="0px" viewBox="0 0 220 160" xmlSpace="preserve">
      <g id="isotype">
        <g id="c1" className="circle">
